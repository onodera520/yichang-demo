...
export const dashboardSuggestions = [
  { id: 'suggestion-001', title: '建议切换NJ仓发货', confidence: 0.92, impact: '影响8笔订单，预计挽回金额 ¥1,260', action: '生成任务' },
  { id: 'suggestion-002', title: '建议补货 120 件至 LA 仓', confidence: 0.88, impact: '影响4笔订单，预计挽回金额 ¥2,134', action: '生成任务' },
  { id: 'suggestion-003', title: '建议更换物流渠道', confidence: 0.75, impact: '影响6笔订单，减少延误投诉', action: '生成任务' },
];
